...
author:     "Paradise"
# header-img: "/img/in-post/cover01.jpg"
header-img: "https://img-blog.csdnimg.cn/20200801151936321.jpg"
mathjax: false
tags:
    - 市场分析
    - 可视化
...
---
<!-- 
# 超市零售数据可视化分析（Plotly 绘图指南） -->

项目首次发布于 **Kesci** 上 -- [超市零售数据分析](https://www.kesci.com/home/project/5f1d6aa394d484002d2f3803)。感兴趣的可以直接上去 Fork 之后自己做。由于上面只能用 Jupyter Notebook，而且还没有权限 DIY 工作环境，不好玩。于是线下重新做一下。（Jupyter Notebook 完全抹杀编程的乐趣 ... 然后上面的 Python 环境还要重新配置才能用 Plotly）
...
<!-- ![](/img/in-post/DA4B_SS/dataprofile.jpg) -->

![](https://img-blog.csdnimg.cn/20200801125036107.jpg)
...
<!-- ![](/img/in-post/DA4B_SS/output1.jpg) -->

> ![](https://img-blog.csdnimg.cn/20200801125035624.jpg)
...
<!-- ![](/img/in-post/DA4B_SS/PRpage.jpg) -->

![](https://img-blog.csdnimg.cn/20200801125035945.jpg)

查看具体的 Changes，发现竟然只是在某个函数中写漏了个参数，所以直接 cd 到 `%PYTHON_HOME%/Lib/site-packages/cufflinks` 里面改一下对应的文件就好了：

<!-- ![](/img/in-post/DA4B_SS/changes.jpg) -->

![](https://img-blog.csdnimg.cn/20200801125035688.jpg)
...
![](https://img-blog.csdnimg.cn/20200801125035978.png)<!-- ![](/img/in-post/DA4B_SS/15.png) -->
...
![](https://img-blog.csdnimg.cn/2020080112503675.png)<!-- ![](/img/in-post/DA4B_SS/17.png) -->
...
fig = py.subplots.make_subplots(1, 2, 
    subplot_titles=['All-Order Counts', 'All-Order Average Price'])
...
![](https://img-blog.csdnimg.cn/20200801125035648.png)<!-- ![](/img/in-post/DA4B_SS/19.png) -->
...
![](https://img-blog.csdnimg.cn/20200801125035392.png)<!-- ![](/img/in-post/DA4B_SS/3.png) -->
...
![](https://img-blog.csdnimg.cn/20200801125035545.png)<!-- ![](/img/in-post/DA4B_SS/5.png) -->
...
![](https://img-blog.csdnimg.cn/20200801125035217.png)<!-- ![](/img/in-post/DA4B_SS/7.png) -->
...
![](https://img-blog.csdnimg.cn/20200801125036257.png)<!-- ![](/img/in-post/DA4B_SS/9.png) -->
...
![](https://img-blog.csdnimg.cn/20200801125036115.png)<!-- ![](/img/in-post/DA4B_SS/11.png) -->
> **上图不同颜色代表不同地区，其中棕色为中国。销售额大且利率高的国家依次有印度、中国、英国**

最后利用上面计算得到的表 `ccountries` ，借助 Tableau 在地图上绘制具体数据：

> ![](https://img-blog.csdnimg.cn/20200801125036633.jpg)<!-- ![](/img/in-post/DA4B_SS/map.jpg) -->
