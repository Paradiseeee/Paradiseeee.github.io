...
#### （2）建模评估
**K-Means** 算法将包含 *N* 个样本的变量 ![X](http://latex.codecogs.com/gif.latex?\\\X) 分成 *K* 个不相交的聚类 ![C](http://latex.codecogs.com/gif.latex?\\\C)，每个聚类用其样本均值 ![uj](http://latex.codecogs.com/gif.latex?\\mu_{j}) 表示，该均值通常称为“质心”。质心可以不是包含在样本集合 ![X](http://latex.codecogs.com/gif.latex?\\\X) 中的点。使用欧氏距离度量，K-Means 算法旨在最小化每个点距离质心的 ![l2](http://latex.codecogs.com/gif.latex?\\l_2) 范数，对应的损失函数如下：

&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;![公式编写参考链接 https://blog.csdn.net/lihaoweicsdn/article/details/83895143](http://latex.codecogs.com/gif.latex?\\sum_{i=0}^{n}min_{\mu_j\in{C}}{(&#124;&#124;x_i-\mu_j&#124;&#124;^2)})
