...
![仿真结果](/post-assets/20200202/simulation.jpg)
...
<img src="/post-assets/20200202/cutoff.png" width="480px">
...
- 本例假设的传染率和潜伏期的概率分布分别为正态分布 *N(3, 4)* 和 *N(7, 4)*：![](/post-assets/20200202/normal_distribution.svg)
