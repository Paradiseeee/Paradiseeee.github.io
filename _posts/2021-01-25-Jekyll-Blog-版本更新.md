...
- 由于部署在 Gitee Page 的时候域名后面加了个 /blog （仓库名），所以 jekyll 引擎渲染 markdown 的时候会出现问题，具体解决参考 [/post-assets/info](https://gitee.com/paradiseeee/blog/blob/master/post-assets/info)。这样会存在问题，暂时用着。

### Version 1.0 的日志看这里

> [README.1.0.md](https://gitee.com/paradiseeee/blog/blob/master/README.1.0.md)
