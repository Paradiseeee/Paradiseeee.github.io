...
- 由于部署在 Gitee Page 的时候域名后面加了个 /blog （仓库名），所以 jekyll 引擎渲染 markdown 的时候会出现问题，具体解决参考 [/post-assets/info](https://github.com/paradiseeee/paradiseeee.github.io/blob/master/post-assets/info)。这样会存在问题，暂时用着。
