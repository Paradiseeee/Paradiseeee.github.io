...
R 功能强大，探索性数据分析（EDA），统计分析模型，数据挖掘模型，数据可视化，样样精通。报告方面有媲美Jupyter Notebook的RMarkdown，使用knit和pandoc生成，颜值颇高。交互方面有shiny，也有让人惊艳的效果。
...
<img src="/img/in-post/R/Rplot.jpeg" width="480px">
...
E.con.interval <- function(x, sig, a, fun){
  	...
  	# fun	-- 对应的分布，可分为两种情况：
	#			1)正态分布 -- fun="norm"；条件为：(满足大样本n>=30|正态总体且sig已知)
...
<img src="/img/in-post/R/linear_model.jpg">
