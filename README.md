...
然后就是将改好的站点合并到之前的 v1.0 上面，也就是本仓库 Github 上的 commit `merge v1.0`：
...
最后就是将 Gitee 上的内容与 Github 上的 内容同步，并且整理好一些文档资源的存放和引用路径等问题，然后就可以开心地写文章啦！`[鼓掌][鼓掌][鼓掌]`
